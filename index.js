      ...
      refresh_chat(){
        ...
        db.ref('chats/').on('value', function(messages_object) {
          ...
          ordered.forEach(function(data) {
            ...
            var message_date_content = document.createElement('p')
            message_date_content.setAttribute('class', 'message_date_content')
            message_date_content.textContent = `${date}`
            ...
            message_content_container.append(message_date_content,message_content)
